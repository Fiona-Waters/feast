...
class SavedDatasetSpec(_message.Message):
    ...
    @_builtins.property
    def columns(self) -> _containers.RepeatedCompositeFieldContainer[Global___ColumnSchema]:
        """Typed column definitions for Iceberg schema."""
...
class ColumnSchema(_message.Message):
    ...
    _HasFieldArgType: _TypeAlias = _Never  # noqa: Y015
    def HasField(self, field_name: _HasFieldArgType) -> _builtins.bool: ...
    _ClearFieldArgType: _TypeAlias = _typing.Literal["name", b"name", "nullable", b"nullable", "type", b"type"]  # noqa: Y015
    def ClearField(self, field_name: _ClearFieldArgType) -> None: ...
    def WhichOneof(self, oneof_group: _Never) -> None: ...

Global___ColumnSchema: _TypeAlias = ColumnSchema  # noqa: Y015
